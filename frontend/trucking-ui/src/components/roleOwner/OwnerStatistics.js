...
export default class OwnerStatistics extends Component {
    ...
    render() {
        return <div style={{color: 'white', backgroundColor: '#4b515d'}}>
            <div className="row animated fadeIn">
                <div className="offset-md-1 col-xl-10 superuserform_companylist">
                    <h2> Скачать статистику</h2>
                    <div className="row">
                        <div onClick={this.xlsCompanyInfo} className="col-xl-2 btn btn-primary" title={"Скачать"}>
                            Отчет по заказам
                    </div>
                        <div onClick={this.xlsFullStat} className="col-xl-2 btn btn-primary" title={"Скачать"}>
                            Полная статистика
                    </div>
                        <div className="col-xl-2 btn btn-primary" onClick={() => {
            ...
            <div id={'content-div'} style={{backgroundColor: '#4b515d'}}>
                <div className="row">
                    <div className="offset-md-1 col-xl-10 superuserform_companylist">
                        <h2> Заказы:</h2>
                        <div className="row">
